...
PublishSubject<RTCThreadUnfollowedFollowed> onThreadUnfollowed = PublishSubject();

PublishSubject<RTCThreadUnfollowedFollowed> onThreadFollowed = PublishSubject();

PublishSubject<RTCChannelUpdated> onChannelUpdated = PublishSubject();
...
//        onUserTypingController.sinkAddSafe(userTypingModel);
      ...
      } else if (type == RemoteConstants.rtChannelUpdated) {
        final model = RTCChannelUpdated(
            uid: json['uid'],
            tid: json['tid'],
            cid: json['cid'],
          ...
          allowCalls: json['channel']['video_calls_enabled'],
          editingMessagesEnabled: json['channel']['editing_messages_enabled']
        );
        onChannelUpdated.sinkAddSafe(model);
        ...
        onUserDeleted
            .sinkAddSafe(RTCUserDeleted(uid: json["uid"], tid: json["tid"]));
      } else if (type == RemoteConstants.rtThreadUnfollowed) {
        onThreadUnfollowed.sinkAddSafe(RTCThreadUnfollowedFollowed(
            tid: json['tid'],
            cid: json['cid'],
            uid: json['uid'],
            pmid: json['pmid']));
      } else if (type == RemoteConstants.rtThreadFollowed) {
        onThreadFollowed.sinkAddSafe(RTCThreadUnfollowedFollowed(
            tid: json['tid'],
            cid: json['cid'],
            uid: json['uid'],
            pmid: json['pmid']));
