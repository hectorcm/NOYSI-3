...
class RTCThreadUnfollowedFollowed {
  String tid, uid, cid, pmid;

  RTCThreadUnfollowedFollowed({required this.tid, required this.cid, required this.uid, required this.pmid});
}

class RTCChannelUpdated {
  String tid, uid, cid, name, title, description;
  bool editingMessagesEnabled, allowCalls;

  RTCChannelUpdated({required this.uid, required this.tid, required this.cid, required this.name, required this.title, required this.description, required this.allowCalls, required this.editingMessagesEnabled});
}
