...
class StringsCa implements StringsBase {
  ...
  String get createNameWarning =>
      "Els noms han de tenir un màxim de 25 caràcters, sense signes de puntuació.";
  ...
  @override
  String get markAllThreads => "Marcar tots com a llegits";

  @override
  String get unfollowAllThreads => "Deixa de seguir tots els fils";

  @override
  String get copyToNewTaskDescription => "Utilitzeu-lo com a descripció de la tasca nova";

  @override
  String get channelDescription => "Descripció del canal";

  @override
  String get channelName => "Nom del canal";

  @override
  String get noAvailableOptions => "No hi ha opcions disponibles";

  @override
  String get allowEditingMessages => "Permet editar missatges";

  @override
  String get allowCalls => "Permetre trucades";

  @override
  String get channelNotFound => "El canal no existeix o no tens accés de lectura";
}
