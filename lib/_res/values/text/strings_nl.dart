...
class StringsNl implements StringsBase {
  ...
  String get createNameWarning =>
      "Namen mogen maximaal 25 tekens bevatten, zonder leestekens.";
  ...
  @override
  String get markAllThreads => "Markeer alles als gelezen";

  @override
  String get unfollowAllThreads => "Stop met het volgen van alle topics";

  @override
  String get copyToNewTaskDescription => "Gebruiken als nieuwe taakbeschrijving";

  @override
  String get channelDescription => "kanaal beschrijving";

  @override
  String get channelName => "Kanaal naam";

  @override
  String get noAvailableOptions => "Geen opties beschikbaar";

  @override
  String get allowEditingMessages => "Bewerken van berichten toestaan";

  @override
  String get allowCalls => "Oproepen toestaan";

  @override
  String get channelNotFound => "Het kanaal bestaat niet of je hebt geen leestoegang";
}