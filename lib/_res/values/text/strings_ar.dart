...
class StringsAr implements StringsBase {
  ...
  String get createNameWarning =>
      "يجب ألا يزيد عدد أحرف الأسماء عن 25 حرفًا بدون علامات الترقيم.";
  ...
  @override
  String get markAllThreads => "اشر عليها بانها قرات";

  @override
  String get unfollowAllThreads => "توقف عن متابعة كل المواضيع";

  @override
  String get copyToNewTaskDescription => "استخدم كوصف جديد للمهمة";

  @override
  String get channelDescription => "قناة صفا";

  @override
  String get channelName => "اسم القناة";

  @override
  String get noAvailableOptions => "لا توجد خيارات متاحة";

  @override
  String get allowEditingMessages => "السماح بتحرير الرسائل";

  @override
  String get allowCalls => "السماح بالمكالمات";

  @override
  String get channelNotFound => "القناة غير موجودة أو ليس لديك حق الوصول للقراءة";
}
