...
class StringsEn implements StringsBase {
  ...
  String get createNameWarning =>
      "Names should have maximum of 25 characters, without punctuation marks.";
  ...
  @override
  String get markAllThreads => "Mark all as read";

  @override
  String get unfollowAllThreads => "Stop following all threads";

  @override
  String get copyToNewTaskDescription => "Use as new task description";

  @override
  String get channelDescription => "Channel description";

  @override
  String get channelName => "Channel name";

  @override
  String get noAvailableOptions => "No options available";

  @override
  String get allowEditingMessages => "Allow editing messages";

  @override
  String get allowCalls => "Allow calls";

  @override
  String get channelNotFound => "The channel doesn't exist or you don't have read access";
}
