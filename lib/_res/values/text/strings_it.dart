...
class StringsIt implements StringsBase {
  ...
  String get createNameWarning =>
      "I nomi devono avere al massimo 25 caratteri, senza segni di punteggiatura.";
  ...
  @override
  String get markAllThreads => "Segna tutti come letti";

  @override
  String get unfollowAllThreads => "Smetti di seguire tutti i thread";

  @override
  String get copyToNewTaskDescription => "Usa come nuova descrizione dell'attività";

  @override
  String get channelDescription => "Descrizione del canale";

  @override
  String get channelName => "Nome del canale";

  @override
  String get noAvailableOptions => "Nessuna opzione disponibile";

  @override
  String get allowEditingMessages => "Consenti la modifica dei messaggi";

  @override
  String get allowCalls => "Consenti chiamate";

  @override
  String get channelNotFound => "Il canale non esiste o non hai accesso in lettura";
}