...
class StringsJa implements StringsBase {
  ...
  @override
  String get markAllThreads => "すべて既読にする";

  @override
  String get unfollowAllThreads => "すべてのスレッドのフォローをやめる";

  @override
  String get copyToNewTaskDescription => "新しいタスクの説明として使用";

  @override
  String get channelDescription => "チャンネルの説明";

  @override
  String get channelName => "チャンネル名";

  @override
  String get noAvailableOptions => "オプションはありません";

  @override
  String get allowEditingMessages => "メッセージの編集を許可する";

  @override
  String get allowCalls => "通話を許可";

  @override
  String get channelNotFound => "チャンネルが存在しないか、読み取りアクセス権がありません";
}
