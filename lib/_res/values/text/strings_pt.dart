...
class StringsPt implements StringsBase {
  ...
  String get createNameWarning =>
      "Os nomes devem ter no máximo 25 caracteres, sem sinais de pontuação.";
  ...
  @override
  String get markAllThreads => "marcar tudo como lido";

  @override
  String get unfollowAllThreads => "Parar de seguir todos os tópicos";

  @override
  String get copyToNewTaskDescription => "Usar como nova descrição da tarefa";

  @override
  String get channelDescription => "descrição do canal";

  @override
  String get channelName => "Nome do canal";

  @override
  String get noAvailableOptions => "Nenhuma opção disponível";

  @override
  String get allowEditingMessages => "Permitir edição de mensagens";

  @override
  String get allowCalls => "Permitir chamadas";

  @override
  String get channelNotFound => "O canal não existe ou você não tem acesso de leitura";
}
