...
class StringsVi implements StringsBase {
  ...
  String get createNameWarning =>
      "Tên phải có tối đa 25 ký tự, không có dấu chấm câu.";
  ...
  @override
  String get markAllThreads => "đánh dấu tất cả như đã đọc";

  @override
  String get unfollowAllThreads => "Shàng đầu sau tất cả các chủ đề";

  @override
  String get copyToNewTaskDescription => "Sử dụng làm mô tả nhiệm vụ mới";

  @override
  String get channelDescription => "Mô tả kênh";

  @override
  String get channelName => "Tên kênh";

  @override
  String get noAvailableOptions => "Không có tùy chọn nào có sẵn";

  @override
  String get allowEditingMessages => "Cho phép chỉnh sửa tin nhắn";

  @override
  String get allowCalls => "Cho phép cuộc gọi";

  @override
  String get channelNotFound => "Kênh không tồn tại hoặc bạn không có quyền đọc";
}
