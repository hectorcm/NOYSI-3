...
class StringsDe implements StringsBase {
  ...
  String get createNameWarning =>
      "Namen sollten maximal 25 Zeichen ohne Satzzeichen enthalten.";
  ...
  @override
  String get markAllThreads => "Alles als gelesen markieren";

  @override
  String get unfollowAllThreads => "Hör auf, allen Threads zu folgen";

  @override
  String get copyToNewTaskDescription => "Als neue Aufgabenbeschreibung verwenden";

  @override
  String get channelDescription => "Kanal Beschreibung";

  @override
  String get channelName => "Kanal Name";

  @override
  String get noAvailableOptions => "Keine Optionen verfügbar";

  @override
  String get allowEditingMessages => "Bearbeiten von Nachrichten zulassen";

  @override
  String get allowCalls => "Anrufe zulassen";

  @override
  String get channelNotFound => "Der Kanal existiert nicht oder Sie haben keinen Lesezugriff";
}
