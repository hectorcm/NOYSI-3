...
class StringsTh implements StringsBase {
  ...
  String get createNameWarning =>
      "ชื่อควรมีอักขระสูงสุด 25 ตัว โดยไม่มีเครื่องหมายวรรคตอน";
  ...
  @override
  String get markAllThreads => "ทำเครื่องหมายทั้งหมดว่าอ่านแล้ว";

  @override
  String get unfollowAllThreads => "งดติดตามทุกกระทู้";

  @override
  String get copyToNewTaskDescription => "ใช้เป็นคำอธิบายงานใหม่";

  @override
  String get channelDescription => "คำอธิบายช่อง";

  @override
  String get channelName => "ชื่อช่อง";

  @override
  String get noAvailableOptions => "ไม่มีตัวเลือก";

  @override
  String get allowEditingMessages => "อนุญาตให้แก้ไขข้อความ";

  @override
  String get allowCalls => "อนุญาตให้โทร";

  @override
  String get channelNotFound => "ไม่มีช่องนี้อยู่หรือคุณไม่มีสิทธิ์อ่าน";
}