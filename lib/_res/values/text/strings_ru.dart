...
class StringsRu implements StringsBase {
  ...
  String get createNameWarning =>
      "Имена должны содержать не более 25 символов без знаков препинания.";
  ...
  @override
  String get markAllThreads => "отметить все как прочитанное";

  @override
  String get unfollowAllThreads => "Прекратить следить за всеми темами";

  @override
  String get copyToNewTaskDescription => "Использовать как новое описание задачи";

  @override
  String get channelDescription => "Описание канала";

  @override
  String get channelName => "Название канала";

  @override
  String get noAvailableOptions => "Нет доступных вариантов";

  @override
  String get allowEditingMessages => "Разрешить редактирование сообщений";

  @override
  String get allowCalls => "Разрешить звонки";

  @override
  String get channelNotFound => "Канал не существует или у вас нет доступа для чтения";
}
