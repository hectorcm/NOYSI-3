...
class StringsFr implements StringsBase {
  ...
  String get createNameWarning =>
      "Les noms doivent comporter au maximum 25 caractères, sans signes de ponctuation.";
  ...
  @override
  String get markAllThreads => "tout marquer comme lu";

  @override
  String get unfollowAllThreads => "Arrêtez de suivre tous les fils de discussion";

  @override
  String get copyToNewTaskDescription => "Utiliser comme nouvelle description de tâche";

  @override
  String get channelDescription => "Description de la chaîne";

  @override
  String get channelName => "Nom du canal";

  @override
  String get noAvailableOptions => "Aucune option disponible";

  @override
  String get allowEditingMessages => "Autoriser la modification des messages";

  @override
  String get allowCalls => "Autoriser les appels";

  @override
  String get channelNotFound => "La chaîne n'existe pas ou vous n'avez pas d'accès en lecture";
}
