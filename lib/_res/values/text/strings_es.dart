...
class StringsEs implements StringsBase {
  ...
  String get createNameWarning =>
      "Los nombres deben tener un máximo de 25 caracteres, sin signos de puntuación.";
  ...
  @override
  String get markAllThreads => "Marcar todos como leído";

  @override
  String get unfollowAllThreads => "Dejar de seguir todos los hilos";

  @override
  String get copyToNewTaskDescription => "Usar como descripción en nueva tarea";

  @override
  String get channelDescription => "Descripción del canal";

  @override
  String get channelName => "Nombre del canal";

  @override
  String get noAvailableOptions => "No hay opciones disponibles";

  @override
  String get allowEditingMessages => "Permitir edición de mensajes";

  @override
  String get allowCalls => "Permitir llamadas";

  @override
  String get channelNotFound => "El canal no existe o no tiene acceso de lectura";
}
