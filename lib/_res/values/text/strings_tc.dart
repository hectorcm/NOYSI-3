...
class StringsTc implements StringsBase {
  ...
  @override
  String get markAllThreads => "標記為已讀";

  @override
  String get unfollowAllThreads => "停止關注所有線程";

  @override
  String get copyToNewTaskDescription => "用作新任務描述";

  @override
  String get channelDescription => "頻道說明";

  @override
  String get channelName => "頻道名稱";

  @override
  String get noAvailableOptions => "沒有可用的選項";

  @override
  String get allowEditingMessages => "允許編輯消息";

  @override
  String get allowCalls => "允許通話";

  @override
  String get channelNotFound => "該頻道不存在或您沒有讀取權限";
}
