...
class StringsSc implements StringsBase {
  ...
  @override
  String get markAllThreads => "标记为已读";

  @override
  String get unfollowAllThreads => "停止关注所有线程";

  @override
  String get copyToNewTaskDescription => "用作新任务描述";

  @override
  String get channelDescription => "频道说明";

  @override
  String get channelName => "频道名称";

  @override
  String get noAvailableOptions => "没有可用的选项";

  @override
  String get allowEditingMessages => "允许编辑消息";

  @override
  String get allowCalls => "允许通话";

  @override
  String get channelNotFound => "频道不存在或您没有读取权限";
}
