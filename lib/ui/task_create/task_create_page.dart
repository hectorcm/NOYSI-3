    ...
    return TXHtmlWidget(
      ...
      style: {
        "div.mobile-description": Style(
            color: R.color.primaryDarkColor, fontSize: FontSize(19)),
        "a": Style(
        ...
        ".partial-message-code-text": Style(
          ...
          padding: HtmlPaddings.symmetric(horizontal: 5), //EdgeInsets.symmetric(horizontal: 5),
          margin: Margins.only(bottom: 5), //EdgeInsets.only(bottom: 5),
        ...
        ".partial-message-preformatted-text": Style(
          ...
          padding: HtmlPaddings.symmetric(horizontal: 10, vertical: 5), //EdgeInsets.symmetric(horizontal: 10, vertical: 5),
          display: Display.block,
        ),
        ".partial-message-strike-text": Style(
          textDecoration: TextDecoration.lineThrough,
        ),
        "p, body": Style(margin: Margins.zero)
      },
