...
class ThreadTypeBloC extends BaseBloC with LoadingBloC, ErrorHandlerBloC {
  ...
  void markAsRead(String threadId) {
    _iThreadRepository.markAsRead(currentTeamId, threadId);
  }

  void unfollow(String threadId) {
    _iThreadRepository.unFollow(currentTeamId, threadId);
  }

  void follow(String threadId) {
    _iThreadRepository.follow(currentTeamId, threadId);
  }
