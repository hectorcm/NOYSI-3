                              ...
                              return TXHomeAppBarWidget(
                                ...
                                onAddChatTap: (drawerChat) {
                                  ...
                                  if (drawerChat.drawerHeaderChatType ==
                                    ...
                                    NavigationUtils.push(
                                        context, PrivateGroupCreatePage());
                                  }
                                },
...
//                  Fluttertoast.showToast(msg: drawerChat.title.toString());
                                ...
                                onNavigationOptionTap: (option) async {
                                  ...
                                  if (option ==
                                    ...
                                    NavigationUtils.push(context,
                                        TaskPage(joinedTeam: bloc.joinedTeam!));
                                  } else if (option ==
  ...
  Widget _showMessageOptions(BuildContext context) {
    ...
    final isSelfUserEvent =
        bloc.currentMessageSelected?.isChannelsMemberJoined == true ||
          ...
          isSending || isSelfUserEvent || isFile || isNoysiEvent
              ...
              : Container(
                  ...
                  child: TXMenuOptionItemWidget(
                    ...
                    text: R.string.copyToNewTaskDescription,
                    onTap: () async {
                      await NavigationUtils.pop(context);
                      NavigationUtils.push(
                          context,
                          TaskCreatePage(
                              joinedTeam: bloc.joinedTeam!,
                              channelId: bloc.inMemoryData.currentChannel!.id,
                              initialDescription: bloc.currentMessageSelected
                                          ?.isIntegrationMessage ==
                                      true
                                  ? bloc.currentMessageSelected!
                                      .getIntegrationMessageContent
                                  : ((bloc.currentMessageSelected?.html ??
                                          bloc.currentMessageSelected?.text) ??
                                      "")));
                    },
                  ),
                ),
