...
class ChannelApi extends BaseApi implements IChannelApi {
  ...
  @override
  Future<ChannelModel> updateChannel(String tid, String cid, String name, String description, bool editMessagesEnabled, bool allowCallsEnabled) async {
    final res = await _networkHandler.put(path: "${Endpoint.teams}/$tid${Endpoint.channels}/$cid", body: jsonEncode({
      "description": description,
      "name": name,
      "editing_messages_enabled": editMessagesEnabled,
      "video_calls_enabled": allowCallsEnabled
    }));
    if (res.statusCode == RemoteConstants.code_success) {
      ChannelModel model = _iChannelConverter.fromJson(res.data);
      return model;
