...
class ChannelConverter implements IChannelConverter {
  ...
  ChannelModel fromJson(Map<String, dynamic> json) {
    final ChannelModel model = ChannelModel(
        ...
        callsEnabled: json['video_calls_enabled'] ?? true,
        editMessagesEnabled: json['editing_messages_enabled'] ?? true,
    );
    return model;
  }
  ...
  Map<String, dynamic> toJson(ChannelModel model) {
    final map = {
      ...
      "video_calls_enabled": model.callsEnabled,
      "editing_messages_enabled": model.editMessagesEnabled,
